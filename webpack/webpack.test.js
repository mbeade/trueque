...
module.exports = {
    ...
    // We can also specify preLoaders which run before our regular loaders. We could put this loader with the other "regular" loaders, but as our application grows, having this separation of concerns will help prevent compilation from getting sluggish.
